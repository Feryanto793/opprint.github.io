						...
						<div class="table-container">
							<table class="table table-filter">
								...
								if(empty($style)){
								  ...
								  include"koneksi.php";
								  $sql = "SELECT id,nama,hp,catatan,ymd,invoice,alamat,SUM(harga * qty) AS totalorder,SUM(qty) AS totalqty FROM pesanan GROUP BY invoice order by ymd desc limit $posisi,$batas";
	...
	<center><a href="kembali.php"><button type='button' class='btn btn-danger'>kembali</button></a></center>
				...
				<div class="content-footer">
					<p>
						...
						Powered By <a href="#" target="_blank">Feryanto R. Prakoso</a>
					</p>
				</div>
			</div>
		</section>
